...
# Load Data
train_images=np.load('npy/train_aug_images.npy')
train_labels=np.load('npy/train_aug_labels.npy')
print("Loaded train data successfully")
print (train_images.shape)

valid_images=np.load('npy/valid_images.npy')
valid_labels=np.load('npy/valid_labels.npy')
...
model_final.compile(loss = "categorical_crossentropy", optimizer = optimizers.Adam(lr=0.001,beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0, amsgrad=True), metrics=["accuracy"])
